...
public partial class Home : ComponentBase
{
    private readonly List<CalendarEvent> _events =
        [
            new(DateOnly.FromDateTime(DateTime.Now), DateOnly.FromDateTime(DateTime.Now.AddDays(7)), [Color.DarkSeaGreen, Color.DarkCyan], Color.Azure),
            new(DateOnly.FromDateTime(DateTime.Now.AddDays(7)), DateOnly.FromDateTime(DateTime.Now.AddDays(9)), [Color.DarkSeaGreen], Color.Azure),
            new(DateOnly.FromDateTime(DateTime.Now.AddDays(10)), DateOnly.FromDateTime(DateTime.Now.AddDays(12)), [Color.DarkRed, Color.DarkOrange], Color.White),
            new(DateOnly.FromDateTime(DateTime.Now.AddDays(13)), DateOnly.FromDateTime(DateTime.Now.AddDays(16)), [Color.DarkRed, Color.DarkOrange, Color.DarkCyan, Color.DarkMagenta], Color.White),
        ];
